...
export type AgStandaloneSeriesOptions<TDatum = DatumDefault, TContext = ContextDefault> = AgOrganizationSeriesOptions<TDatum, TContext> | AgPyramidSeriesOptions<TDatum, TContext> | AgTreemapSeriesOptions<TDatum, TContext> | AgSunburstSeriesOptions<TDatum, TContext> | AgSankeySeriesOptions<TDatum, TContext> | AgChordSeriesOptions<TDatum, TContext>;
